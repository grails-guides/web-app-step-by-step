...
However, Grails allows an easy http://docs.grails.org/latest/guide/single.html#customizingUrlFormat[customization of URL formats].

To achive a hyphenated URL format we need to add the next configuration parameter:
