...
These commands will generate two Groovy classes, under
...
As is common in many Java projects, we have created a “package” for our
domain classes. This helps distinguish our classes from classes from
